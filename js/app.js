...
// Left arrow.
    case "left":
        this.x = this.x - 100;
        if (this.x < 0) {// If at edge, reset player x position.
            this.x = 0;
        }
        break;
...
// Right arrow.
    case "right":
        this.x =  this.x + 100;
        if (this.x > 400) {// If at edge, reset player x position.
            this.x = 400;
        }
        break;
...
// Down arrow
    case "down":
        this.y = this.y + 80;
        if (this.y > 415) {//If at edge, reset player y position.
            this.y = 415;
        }
        break;
...
// Up arrow
    case "up":
        this.y = this.y - 85;
        if (this.y < 0) {// If at edge, reset player y position.
            this.y = 0;
        }
        break;
    }
